...
Now click **+Add**, choose **Database**, **MariaDB (Ephemeral)**, and then **Instantiate Template**. A form opens. Check that the first field corresponds to the correct Project and leave the remaining fields as they are. Finally click **Create** at the end of the form.
