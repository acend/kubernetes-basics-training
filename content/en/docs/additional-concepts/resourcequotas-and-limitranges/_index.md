...
```bash
{{% param cliToolName %}} get resourcequota --namespace $USER-quota
```

To show in detail what kinds of limits the quota imposes:

```bash
{{% param cliToolName %}} describe resourcequota <quota-name> --namespace $USER-quota
```
...
```bash
{{% param cliToolName %}} describe limitrange --namespace $USER-quota
```
...
```bash
{{% param cliToolName %}} describe quota --namespace $USER-quota
```
...
```bash
{{% param cliToolName %}} apply -f pod_stress2much.yaml --namespace $USER-quota
```
...
```bash
{{% param cliToolName %}} get pods --watch --namespace $USER-quota
```
...
```bash
{{% param cliToolName %}} get pod stress2much --output yaml --namespace $USER-quota
```
...
```bash
{{% param cliToolName %}} delete pod stress2much --namespace $USER-quota
```
...
```bash
{{% param cliToolName %}} apply -f pod_stress.yaml --namespace $USER-quota
```
...
```bash
{{% param cliToolName %}} apply -f pod_overbooked.yaml --namespace $USER-quota
```
...
```bash
{{% param cliToolName %}} get quota --output yaml --namespace $USER-quota
```
