...
First, we are going to directly start a new Pod. For this we first have to device our Kubernetes Pod resource. Create a new file `03_pod.yaml` with the following content:
